...
fn main() -> io::Result<()> {
    ...
    // // let start = Instant::now();
    // // let resultnums14 = repeated_n_times_blocks3(nums1.clone());
    // // let duration = start.elapsed();
    // // println!("Function Parallel 3, Time elapsed: {:?}", duration);
    ...
    // // let start = Instant::now();
    // // let resultnums24 = repeated_n_times_blocks3(nums2.clone());
    // // let duration = start.elapsed();
    // // println!("Function Parallel 3, Time elapsed: {:?}", duration);
    ...
    let mut i: i32 = 0;
    svg("results/join.svg", || {
        i = repeated_n_times_join(nums);
    })
